...
namespace Raptor.Services.Authentication
{
    ...
    /// </summary>
    public static class RaptorCookieAuthenticationDefaults
    {
        /// <summary>
        ...
        /// </summary>
        public static readonly string CookiePrefix = ".Raptor.";

        /// <summary>
        /// The issuer that should be used for any claims that are created
        /// </summary>
        public static readonly string ClaimsIssuer = "RaptorCMS";
