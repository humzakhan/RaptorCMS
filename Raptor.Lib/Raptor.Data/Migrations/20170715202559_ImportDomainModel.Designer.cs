...
namespace Raptor.Data.Migrations
{
    ...
    [Migration("20170715202559_ImportDomainModel")]
    partial class ImportDomainModel
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("Raptor.Data.Models.Post", b =>
                {
                    b.Property<int>("PostId")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Raptor.Data.Models.Comment", b =>
                {
                    b.HasOne("Raptor.Data.Models.Post", "Post")
                        .WithMany("Comments")
