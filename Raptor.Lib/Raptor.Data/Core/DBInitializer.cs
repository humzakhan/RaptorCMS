...
namespace Raptor.Data.Core
{
    public class DbInitializer
    {
        ...
        public DbInitializer(RaptorDbContext context) {
            _context = context;
        }
        ...
        private void AssignRolesToDefaultUser() {
            if (_context.PersonRoles.Any()) return;

            var roleAdmin = _context.Roles.SingleOrDefault(r => r.SystemKeyword == "admin");
            var roleMod = _context.Roles.SingleOrDefault(r => r.SystemKeyword == "mod");
            var roleUser = _context.Roles.SingleOrDefault(r => r.SystemKeyword == "user");

            var defaultUser = _context.People.SingleOrDefault(u => u.Username == "Admin");
            ...
            _context.PersonRoles.AddRange(userRoles);
            _context.SaveChanges();
        }
        ...
        private void InsertDefaultActivityLogTypes()
        {
            ...
            _context.ActivityLogTypes.AddRange(activityLogTypes);
            _context.SaveChanges();
        }
    }
}
